      ...
      <div class="box">
        ...
        <div class="box-body">
          <form action="<?php echo base_url('user/admin/produk/simpanedit') ?>" method='post'  enctype="multipart/form-data">
              ...
              <?php   
                $kat = ['Juice','Makanan','Minuman','Paket PMJ 1','Paket PMJ 2','Pasta','Pizza','Salad','Soup','Soup dan Salad'];
               ?>
              <select name="kategori" class="form-control">
                <?php   foreach ($kat as $v) { ?>
                <option <?php   if($v==$produk['kategori_produk']){echo "selected";} ?>><?php echo $v ?></option>
                <?php } ?>
              </select>
            </div>
