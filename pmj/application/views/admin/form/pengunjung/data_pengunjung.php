               ...
               <?php
                ...
                <td>
                  <?php if ($d1['kategori']=='Kelompok'): ?>
                    <a href="<?php echo base_url('user/admin/pengunjung/detail/'.$d1['id_pengunjung']) ?>" class="btn btn-info btn-xs" >Detail</a>
                    
                  <?php else: ?>
                    <a href="<?php echo base_url('user/admin/pengunjung/detail_pribadi/'.$d1['id_pengunjung']) ?>" class="btn btn-warning btn-xs" >Detail</a>
                  <?php endif ?>
