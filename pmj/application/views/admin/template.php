...
if ($this->session->userdata('status')!='login') { ?>
 <script>
   alert('Anda sudah keluar. silahkan lakukan login ulang');
...
$id_admin = $this->session->userdata('id_user');
  ...
  $q_admin= $this->db->query("SELECT * from $tabel where id = '$id_admin'")->row_array() ;
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                  <!-- <a href="<?php //echo base_url('home/beranda/logout') ?>" class="btn btn-default btn-flat">Ganti Password</a> -->
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url('home/beranda/logout') ?>" class="btn btn-info btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <?php if ($level=='Admin') { ?>
          ...
          <li><a href="<?php echo base_url('user/admin/manage_admin/') ?>"><i class="fa fa-book"></i><span style="color:aqua">Data Admin</span></a></li>
        ...
        <li class="header">Laporan</li>
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('user/admin/laporan/penjualan/') ?>" style="color:aqua"><i class="fa fa-book"></i> Laporan Penjualan Produk </a></li>
            <li><a href="<?php echo base_url('user/admin/laporan/visit/') ?>" style="color:aqua"><i class="fa fa-book"></i> Laporan Visit</a></li>
            <li><a href="<?php echo base_url('user/admin/laporan/poin/') ?>" style="color:aqua"><i class="fa fa-book"></i> Laporan Penukaran Poin</a></li>
          </ul>
        </li>
        ...
        <li><a href="<?php echo base_url('user/admin/pengunjung/') ?>"><i class="fa fa-book"></i><span  style="color:aqua">Data Pengunjung</span></a></li>
