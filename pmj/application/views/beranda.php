    ...
    <nav class="main-navbar">
      <div class="container">
        ...
        <ul class="main-menu">
          ...
          <?php $kontak = $this->db->query("SELECT * from tabel_bantu")->row_array()['wa'] ?>
          <li><a href="whatsapp://send?text=Hello&phone=<?php echo $kontak ?>">Contact</a></li>
...
<section class="hero-section">
    <div class="hero-slider owl-carousel">
      ...
      <div class="hs-item set-bg" data-setbg="<?php echo base_url() ?>file/gambar/b1.jpeg">
        <div class="container">
          <div class="row">
            <div class="col-xl-10 col-lg-7 text-white">
              ...
              <p>l. Jend. A Yani No.21, Kp. Jao, Kec. Padang Bar., Kota Padang, Sumatera Barat 25114</p>
        ...
        <div class="hs-item set-bg" data-setbg="<?php echo base_url() ?>file/gambar/b2.jpg">
        <div class="container">
          <div class="row">
            <div class="col-xl-10 col-lg-7 text-white">
              <h4>Pizza Maket Junior</h4>
